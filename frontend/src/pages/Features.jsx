  ...
  const features = [
    {
      ...
      icon: "https://www.svgrepo.com/show/474277/calendar.svg",
    ...
    },
    {
      ...
      icon: "https://www.svgrepo.com/show/510174/search-sm.svg",
    ...
    },
    {
      ...
      icon: "https://www.svgrepo.com/show/429781/robot-face-chatbot.svg",
    ...
    },
    {
      ...
      icon: "https://www.svgrepo.com/show/475151/line-chart.svg",
    ...
    <div className="flex min-h-screen flex-col bg-[#F3EFEA] font-['Lato']">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-grow flex-col px-6 py-10">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold text-[#8B2020] uppercase tracking-wide">Layanan NutriBy</h1>
          <p className="mt-3 text-gray-600 text-lg">Pilih fitur di bawah ini untuk membantu perjalanan gizi si Kecil.</p>
        </div>
          ...
          {features.map((feature) => (
            ...
            >
              <div className="mb-4 flex h-24 w-24 shrink-0 items-center justify-center rounded-2xl bg-red-50 p-4 transition-colors group-hover:bg-red-100 sm:mb-0">
                <img src={feature.icon} alt={feature.title} className="h-full w-full object-contain opacity-80 group-hover:opacity-100" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-gray-800 group-hover:text-[#8B2020] transition-colors">{feature.title}</h2>
                <p className="mt-2 text-sm text-gray-500 leading-relaxed">{feature.desc}</p>
                <span className="mt-3 inline-block font-bold text-[#8B2020] text-sm group-hover:underline underline-offset-4">Buka Fitur →</span>
              </div>
            </Link>
          ))}
        </div>
