...
export default function Dashboard() {
  ...
  const limitBulanan = activeMealPlan
    ? parseFloat(activeMealPlan.max_budget_limit)
    : 0;
  const costBulanan = activeMealPlan
    ? parseFloat(activeMealPlan.actual_total_cost)
    : 0;
      ...
      <main className="mx-auto w-full max-w-7xl flex-grow p-4 py-8 md:p-8">
        ...
        <div className="mb-8 overflow-hidden rounded-3xl bg-white p-6 shadow-sm md:p-10 relative flex items-center justify-between">
          <div className="relative z-10 max-w-2xl">
            ...
            <p className="mt-4 text-base text-gray-600 md:text-lg">
              ...
              . Status gizi global saat ini adalah{" "}
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
          <div className="flex flex-col gap-6 lg:col-span-1">
            ...
            <div className="rounded-3xl bg-white p-6 shadow-sm border border-gray-100">
              <h2 className="mb-4 text-lg font-bold text-gray-800 border-b pb-2">
                Estimasi Anggaran Belanja MPASI
              </h2>
              {activeMealPlan ? (
                  ...
                  <div className="border-b pb-3">
                    ...
                    <div className="flex justify-between text-sm mt-1">
                      ...
                      <span className="font-semibold text-gray-700">
                        Rp {Math.round(limitMingguan).toLocaleString("id-ID")}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between text-xs mt-1 bg-green-50 p-1 rounded text-green-700 font-bold">
                      ...
                      <span>
                        Rp {Math.round(hematMingguan).toLocaleString("id-ID")}
                      </span>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="flex justify-between text-sm mt-1">
                      <span className="text-gray-500">Batas Maksimal:</span>
                      <span className="font-semibold text-gray-700">
                        Rp {Math.round(limitBulanan).toLocaleString("id-ID")}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-500">Biaya Riil AI:</span>
                    ...
                    <div className="flex justify-between text-xs mt-1 bg-green-100 p-1 rounded text-green-800 font-bold">
                      <span>Hemat Belanja:</span>
                      <span>
                        Rp {Math.round(hematBulanan).toLocaleString("id-ID")}
                      </span>
                    </div>
                  </div>
                </div>
